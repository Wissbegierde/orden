...
class _ShoppingScreenState extends State<ShoppingScreen> {
  bool _handleVoiceCommand(String normalized) {
    if (VoiceCommandService.matchesAny(normalized, VoiceCommandService.registrarCompraAliases)) {
      Navigator.push(context, MaterialPageRoute(builder: (_) => const RegisterPurchaseScreen()));
      return true;
